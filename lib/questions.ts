...
export type Question = {id:string;subject:Subject;prompt:string;answers:string[];explanation:string;passage?:string;diagram?:{kind:string;items:number[]};difficulty:string};
