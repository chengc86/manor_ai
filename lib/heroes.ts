...
export const HEROES=[
 ...
 {name:'Flint',role:'Guardian',price:140,power:34,range:1.8,cooldown:1.4,colour:'#ffcf6b',attack:'SLASH!',description:'Heavy sword strikes beside the path.',tiers:['Squire','Manor Knight','Champion'],costs:[100,200],growth:[{range:.3,speed:.15},{range:.6,speed:.3}],upgrade:['A longer blade and stronger strikes.','Champion strikes with extra reach and speed.']},
 {name:'Tempest',role:'Stormcaller',price:160,power:16,range:3.5,cooldown:1.6,colour:'#8de5ff',attack:'BOLT!',description:'Lightning hits two monsters each cast.',tiers:['Cloud Keeper','Thunder Wing','Storm Sage'],costs:[100,200],growth:[{range:.5,speed:.15},{range:1,speed:.3}],upgrade:['Stronger lightning and a wider storm.','Lightning strikes three targets at once.']},
 {name:'Pip',role:'Duellist',price:80,power:9,range:2,cooldown:.65,colour:'#d8ff9c',attack:'SWISH!',description:'Fast twin blades for tight corners.',tiers:['Trail Runner','Twinblade','Wind Dancer'],costs:[60,120],growth:[{range:.25,speed:.1},{range:.5,speed:.2}],upgrade:['Faster blades with a little more reach.','Lightning-fast strikes and stronger blades.']},
 {name:'Rowan',role:'Marksman',price:120,power:25,range:5.5,cooldown:2,colour:'#ffb887',attack:'BOLT!',description:'Crossbow bolts cover distant stretches.',tiers:['Lookout','Sharpshooter','Manor Sentinel'],costs:[80,160],growth:[{range:.75,speed:.15},{range:1.5,speed:.3}],upgrade:['Powerful bolts reach more of the path.','Seven-square reach with faster reloads.']},
 {name:'Ember',role:'Flamekeeper',price:180,power:18,range:2.8,cooldown:1.8,colour:'#ff9869',attack:'FLAME!',description:'Flames splash onto nearby monsters.',tiers:['Spark','Blaze','Inferno'],costs:[120,240],growth:[{range:.3,speed:.15},{range:.6,speed:.3}],upgrade:['Stronger flames and a wider splash.','A broad flame burst for crowded waves.']},
