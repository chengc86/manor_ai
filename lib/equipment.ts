...
export const EQUIPMENT=[
 {id:'standard',name:'Pencil Lance',price:100,description:'Accurate pencil magic. Pierces a line of monsters from level 3.',effect:'Piercing',art:0},
 {id:'swift',name:'Chalk Blaster',price:120,description:'Very quick chalk shots; level 3 marks targets for extra damage.',effect:'Rapid fire + mark',art:1},
